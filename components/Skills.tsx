...
function Skills({ skills }: Props) {
    return (
        <motion.div
            ...
            className="relative mx-auto flex  h-screen min-h-screen max-w-[2000px] flex-col items-center justify-center overflow-hidden text-center md:text-left xl:flex-row xl:px-10"
        >
